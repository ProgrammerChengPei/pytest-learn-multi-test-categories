...
class TestInterface:
    ...
    def test_interface_get_status(self, test_state, test_client):
        ...
        This test verifies the get_status command returns correct structure and data.
        ...
        try:
            ...
            print(f"✗ get_status interface test failed: {e}")
            raise
    ...
    def test_interface_health_check(self, test_state, test_client):
        ...
        This test verifies the health_check command returns healthy status.
        ...
        try:
            ...
            print(f"✗ health_check interface test failed: {e}")
            raise
    ...
    def test_interface_echo(self, test_state, test_client):
        ...
        This test verifies the echo command returns the original text with server timestamp.
        ...
        try:
            ...
            print(f"✗ echo_with_timestamp interface test failed: {e}")
            raise
    ...
    def test_interface_batch_requests(self, test_state, test_client):
        ...
        try:
            ...
            print(f"✗ Batch requests test failed: {e}")
            raise
    ...
    def test_interface_latency(self, test_state, test_client):
        ...
        try:
            ...
            print(f"✗ Interface latency test failed: {e}")
            raise
    ...
    def test_interface_complete(self, test_state, test_client, test_artifacts_dir):
        ...
        This test marks the interface test as completed and saves results.
        此测试标记接口测试完成并保存结果。
