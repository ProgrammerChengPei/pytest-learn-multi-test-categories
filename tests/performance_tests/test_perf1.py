...
class TestPerformance:
    ...
    @pytest.mark.dependency(name="test_performance_latency")
    ...
    def test_performance_throughput(self, test_client):
        """
    ...
    def test_performance_concurrent(self, test_config):
        """
    ...
    def test_performance_stress(self, test_client):
        """
    ...
    def test_performance_complete(self, test_client, reports_dir):
        """
